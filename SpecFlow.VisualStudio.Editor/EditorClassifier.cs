...
namespace SpecFlow.VisualStudio.Editor
{
    ...
    internal class EditorClassifierProvider : IClassifierProvider
    {
        ...
        {
            return buffer.Properties.GetOrCreateSingletonProperty<EditorClassifier>(delegate { return new EditorClassifier(ClassificationRegistry); });
        }
    }
    ...
    /// </summary>
    class EditorClassifier : IClassifier
    {
